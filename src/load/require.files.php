...
#FIBERS ########################################################################
################################################################################
require_once("{$_SESSION['config']['pwd']}/../functions/fibers_exec.func.php");

################################################################################
#PARSER AND VALIDATION TAG TITLE################################################
################################################################################
require_once("{$_SESSION['config']['pwd']}/../functions/title.func.php");

################################################################################
#This function will send the contents of the output buffer (if any)#############
################################################################################
require_once("{$_SESSION['config']['pwd']}/../functions/plus.func.php");

#################################################################################
#SECURITIES VALIDATION DOUBLE####################################################
#################################################################################
require_once("{$_SESSION['config']['pwd']}/../functions/not_empty.func.php");
...
#VALID MENU OPTIONS#############################################################
################################################################################
require_once("{$_SESSION['config']['pwd']}/../functions/validate_options.func.php");
...
#REMOVE VALUE URL###############################################################
################################################################################
require_once("{$_SESSION['config']['pwd']}/../functions/remove.func.php");
...
#GET STATUS HTTP URL############################################################
################################################################################
require_once("{$_SESSION['config']['pwd']}/../functions/get_status_url.func.php");
...
#CHECK CMS######################################################################
################################################################################
require_once("{$_SESSION['config']['pwd']}/../functions/simple_checke_cms.func.php");
...
################################################################################
require_once("{$_SESSION['config']['pwd']}/../functions/filter_url_tag.func.php");
...
################################################################################
require_once("{$_SESSION['config']['pwd']}/../functions/filter_hostname.func.php");
...
################################################################################
require_once("{$_SESSION['config']['pwd']}/../functions/validate_error_db.func.php");
...
################################################################################
require_once("{$_SESSION['config']['pwd']}/../functions/cse_rand_id.func.php");
...
################################################################################
require_once("{$_SESSION['config']['pwd']}/../functions/filter_domain_unique.func.php");

################################################################################
#GENERATOR RANGE IP#############################################################
#GENERATOR RANGE IP RANDOM######################################################
################################################################################
require_once("{$_SESSION['config']['pwd']}/../functions/generator_ip.func.php");
...
################################################################################
require_once("{$_SESSION['config']['pwd']}/../functions/crypt_string.func.php");
